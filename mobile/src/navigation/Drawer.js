      ...
      <SafeAreaView style={{flex: 1}} forceInset={{top: "always", horizontal: "never"}}>
          ...
          <View>
              ...
              <DrawerItem 
                ...
                icon = {()=><MaterialCommunityIcons name="logout-variant" size={20}/>}
              />
          </View>
      </SafeAreaView>
  );
...
const DrawNav = (props) => {
  ...
  const list = group.map((groupName) => <Drawer.Screen key = {groupName} name={groupName} component={TabNav} options={{
    drawerIcon: ({ color }) => (
